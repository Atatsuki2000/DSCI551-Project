DROP TABLES IF EXISTS all_teams, all_team_game_stats, current_players, all_draft_picks, all_players_season_stats_2023_2024;

CREATE TABLE IF NOT EXISTS all_team_game_stats(
    home_team_id INTEGER,
    game_id INTEGER,
    game_date DATE,
    home_team_abbr varchar(3),
    visitor_team_abbr varchar(3),
    WL varchar(1),
    W INTEGER,
    L INTEGER,
    W_PCT REAL,
