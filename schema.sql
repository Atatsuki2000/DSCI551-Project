...
DROP DATABASE IF EXISTS nba_0;
DROP DATABASE IF EXISTS nba_1;

-- Create new databases
CREATE DATABASE nba_0;
CREATE DATABASE nba_1;

-- Switch to the nba_0 database to create tables
USE nba_0;

-- Create tables for nba_0
...
-- Switch to the nba_1 database to create tables
USE nba_1;
